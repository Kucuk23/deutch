...
# DataFrame'i oluştur
df = pd.read_csv("Deutch_Data_2020.csv", sep=";", skiprows=[1])
...
max_indic_height = np.zeros(len(whole_datas))
...
whole_datas['max_indic'] = max_indic_height

# CSV dosyasına yazmak istediğiniz dosya yolunu belirtin
output_csv_path = "llj_indexed_datas_2020.csv"
